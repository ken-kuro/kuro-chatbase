...
declare interface KurobaseFireworksModelInput {
  temperature?: number;
  top_p?: number;
  streaming?: boolean;
  max_tokens?: number;
...
export class KurobaseFireworksModel extends BaseChatModel
  implements KurobaseFireworksModelInput {
  ...
  constructor(
    fields?: Partial<KurobaseFireworksModelInput> & BaseChatModelParams,
  ) {
    super(fields ?? {});
