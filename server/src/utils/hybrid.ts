...
export interface KurobaseLibArgs extends BaseRetrieverInput {
  botId: string;
...
export class KurobaseHybridRetrival extends BaseRetriever {
  static lc_name() {
    return "KurobaseHybridRetrival";
  }

  lc_namespace = ["langchain", "retrievers", "kurobase"];
  botId: string;
  sourceId: string | null;
  ...
  constructor(embeddings: Embeddings, args: KurobaseLibArgs) {
    super(args);
