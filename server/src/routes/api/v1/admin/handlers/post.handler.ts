...
import {
  ...
  UpdateKurobaseSettingsRequest,
} from "./type";
import { getSettings } from "../../../../../utils/common";
import * as bcrypt from "bcryptjs";

export const updateKurobaseSettingsHandler = async (
  request: FastifyRequest<UpdateKurobaseSettingsRequest>,
  reply: FastifyReply,
) => {
  ...
  await primsa.kurobaseSettings.update({
    where: {
      id: 1,
    },
    data: request.body,
