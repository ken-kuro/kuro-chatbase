...
CREATE TABLE "KurobaseSettings" (
    ...
    CONSTRAINT "KurobaseSettings_pkey" PRIMARY KEY ("id")
);
...
INSERT INTO "KurobaseSettings" ("id", "noOfBotsPerUser", "allowUserToCreateBots", "allowUserToRegister")
VALUES (1,'10', '1', '0');