...
CREATE TABLE "KurobaseModels" (
    ...
    CONSTRAINT "KurobaseModels_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "KurobaseModels_model_id_key" ON "KurobaseModels"("model_id");


-- Insert the default models


INSERT INTO "KurobaseModels" ("name", "model_id", "model_type", "model_provider", "stream_available", "local_model", "config") VALUES
